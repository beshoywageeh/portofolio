    ...
    originalRepos.forEach(async (repo) => {
      ...
      card.innerHTML = `
                ...
                <div class="card-footer bg-transparent">
                    <a href="${
                      repo.html_url
                    }/commits" class="btn btn-sm border border-gray-300 text-gray-700 hover:bg-gray-100" target="_blank">
                        <i class="bi bi-git"></i> View Commits
                    </a>
                    <a href="${
                      repo.html_url
                    }/issues" class="btn btn-sm border border-gray-300 text-gray-700 hover:bg-gray-100 ms-2" target="_blank">
                        <i class="bi bi-exclamation-circle"></i> Issues
                    </a>
                    <a href="${
                      repo.html_url
                    }" class="btn btn-sm border border-gray-300 text-gray-700 hover:bg-gray-100 ms-2" target="_blank">
